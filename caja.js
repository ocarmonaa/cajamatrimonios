...
class CajaMatrimonios {
    ...
    async agregarEntrada(monto, concepto, fecha) {
        try {
            ...
            nuevaEntrada.set("fecha", new Date(fecha));
    ...
    async agregarGasto(monto, concepto, fecha) {
        try {
            ...
            nuevoGasto.set("fecha", new Date(fecha));
    ...
    mostrarTransacciones() {
        ...
        const showAllMonths = document.getElementById("show-all-months")?.checked || false;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Crear checkbox para mostrar todos los meses
    ...
    allMonthsCheckbox.innerHTML = `
        <label for="show-all-months">
            <input type="checkbox" id="show-all-months">
